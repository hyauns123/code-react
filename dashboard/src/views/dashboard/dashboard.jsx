...
const tableData = [
  {
    movie: "/assets/images/movie-thumb/07.jpg",
    name: "Boop Bitty",
    time: "",
    rating: "8.2",
    category: "Thriller",
  ...
  {
    movie: "/assets/images/movie-thumb/01.jpg",
    name: "Champions",
    time: "1hr 40min",
    rating: "9.2",
    category: "Horror",
  ...
  {
    movie: "/assets/images/movie-thumb/05.jpg",
    name: "Last Race",
    time: "",
    rating: "7.2",
    category: "Horror",
  ...
  {
    movie: "/assets/images/movie-thumb/04.jpg",
          ...
          <Col sm="12">
            <Card>
              <Card.Header className="d-flex justify-content-between">
                <Card.Header.Title>
                  <h4 className="card-title">{t("dashboard.Viewed_Items")}</h4>
                </Card.Header.Title>
