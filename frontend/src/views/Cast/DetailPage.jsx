...
const DetailPage = memo(() => {
  const cast = {
    ...
    sites: t("detail_page.iqonic_design"),
    site_link: "https://iqonic.design/",
    dob: "{ t('detail_page.october') }15, 1982",
    place_of_birth: t("detail_page.westminster_london"),
    height: "6′ 1¾″ (1.87 m)",
    parents: t("detail_page.diana_patricia"),
    siblings: t("detail_page.emma_hiddleston"),
    works: [
      {
        id: "1",
        ...
        <Container fluid>
          <Row>
            <Col lg="3" md="5">
              ...
              <p>{cast.t("detail_page.height")}</p>
              <h6 className="font-size-18 text-white fw-500">
                {t("detail_page.parents")} & {t("detail_page.relatives")} :
              </h6>
              <p className="mb-0">
                {cast.t("detail_page.parents")}{" "}
                <span className="text-primary">
                  {cast.t("detail_page.sibling")}
                </span>
