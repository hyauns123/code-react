                        ...
                        <Row>
                            <Col md="12">
                                <Form.Group className='form-group'>
                                    <Form.Label>{t('detail_page.your_review')} <span className='text-danger'> *</span></Form.Label>
                                    <textarea className='form-control' name='comment' cols="5" rows="8" required></textarea>
                                </Form.Group>
                            </Col>
                            <Col md="6">
                                <Form.Group className='form-group'>
                                    <Form.Label>{t('detail_page.name')} <span className='text-danger'> *</span></Form.Label>
                                    <Form.Control type='text' name='author' size='30' required />
                                </Form.Group>
                            </Col>
                            <Col md="6">
                                <Form.Group className='form-group'>
                                    <Form.Label>{t('detail_page.email')} <span className='text-danger'> *</span></Form.Label>
