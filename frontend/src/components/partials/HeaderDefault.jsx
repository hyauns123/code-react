          ...
          <Container fluid className="navbar-inner">
            <div className="d-flex align-items-center justify-content-between w-100 landing-header">
              ...
              <div className="right-panel">
                ...
                <div
                  className={`navbar-collapse ${show === true ? "show" : ""}`}
                    ...
                    >
                      <div className="search-box">
                        <a
                          href="#"
                          onClick={() => setShow(!show)}
                          className={` nav-link p-0 ${show === true ? "show" : ""
                            }`}
                          id="search-drop"
                        ...
                        <ul
                          className={`dropdown-menu p-0 dropdown-search m-0 iq-search-bar ${show === true ? "show" : ""
                            }`}
                          style={{ width: "20rem" }}
